		...
		//Scroleamos, para ello es necesario ejecutar funcionalidad Javascript
		  ...
		  while (findElement == false) {
			  ...
			  try {
				  ...
				  WebElement element = (WebElement) wait.until(ExpectedConditions.visibilityOfElementLocated(By.linkText("Game Boy. Buen Estado Estético, Para Revisar Funcionamiento")));
				  findElement = true;
				  element.click();
			  }
			  catch(Exception e){
